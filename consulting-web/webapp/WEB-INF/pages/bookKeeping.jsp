				...
				<div class="row">
					...
					<nav class="collapse navbar-collapse clearfix" role="navigation">
						<ul class="nav navbar-nav navbar-right">
							...
							<li class=""><a href="bookKeeping.htm">Book Keeping</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<ul>
							...
							<li>We'll provide you a team of bookkeepers with expertise in your industry. We work with your existing accounting software & tools, but can also help you make the move to newer technologies.</li> 
