			...
			<div class="container">
				<div class="error-page text-center">
					...
					<div class="error-message">
						<h3>Company Creation Request Successful</h3>
					</div>
					...
					<div class="error-body">
						<form action="companyPayment.htm" method="post">
							<input type="hidden" id="Csrf_RQ_PARAM_NAME" name="Csrf_RQ_PARAM_NAME" value="${Csrf_RQ_PARAM_NAME}" /> <input type="hidden"
								name="companyRequestIdForPayment" id="companyRequestIdForPayment" value="${companyRequestId}" />
