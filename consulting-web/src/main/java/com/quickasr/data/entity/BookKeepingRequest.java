...
public class BookKeepingRequest implements java.io.Serializable{

	private static final long serialVersionUID = -352707685846934331L;
	
	private int bookKeepingRequestId;
	...
	public int getBookKeepingRequestId() {
		return bookKeepingRequestId;
	}
	public void setBookKeepingRequestId(int bookKeepingRequestId) {
		this.bookKeepingRequestId = bookKeepingRequestId;
	}
